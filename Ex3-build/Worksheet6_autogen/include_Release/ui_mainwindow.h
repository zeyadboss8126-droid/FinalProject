...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/icons/Open.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/icons/Save.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSave->setIcon(icon1);
        actionSave->setMenuRole(QAction::MenuRole::NoRole);
        actionExit = new QAction(MainWindow);
        actionExit->setObjectName("actionExit");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/icons/Exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Button1->setText(QCoreApplication::translate("MainWindow", "Button 1", nullptr));
        Button2->setText(QCoreApplication::translate("MainWindow", "Button 2", nullptr));
